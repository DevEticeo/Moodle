...
$string['antivirussettings:config'] = 'Change antivirus configuration.';
...
$string['authsettings:config'] = 'Change authentication plugins configuration.';
...
$string['blocksettings:config'] = 'Change blocks configuration.';
...
$string['customfieldsettings:config'] = 'Change custom fields configuration.';
...
$string['dataformatsettings:config'] = 'Change data format settings configuration.';
...
$string['editorsettings:config'] = 'Change editor plugins configuration.';
$string['editrole'] = 'Edit role';
$string['editxrole'] = 'Edit {$a} role';
$string['enrolments:config'] = 'Change enrolment plugins configuration.';
...
$string['filtersettings:config'] = 'Change filter plugins configuration';
$string['formatsettings:config'] = 'Change course formats configuration.';
...
$string['mediaplayers:config'] = 'Change media players configuration.';
$string['mlbackendsettings:config'] = 'Change machine learning backend plugins configuration.';
$string['modsettings:config'] = 'Change activity modules configuration.';
...
$string['paymentgateways:config'] = 'Change data format settings configuration.';
...
$string['repositorysettings:config'] = 'Change portfolio settings configuration.';
